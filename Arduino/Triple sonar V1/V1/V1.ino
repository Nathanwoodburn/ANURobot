...
const int epin3 = A5;
const int s_W = 5; // Distance to the side walls //will need to adjust these after trying it out
const int f_W = 8; // Distance to the front wall
const int d_v_s = 3; // variations in the distance to the side wall while driving forward
